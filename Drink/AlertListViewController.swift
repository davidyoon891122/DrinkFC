...
class AlertListTableViewController: UITableViewController {
    ...
    @IBAction func addAlertButtonTapped(_ sender: UIBarButtonItem) {
        guard let addAlertVC = storyboard?.instantiateViewController(identifier: "AddAlertViewController") as? AddAlertViewController else {
            return
        }
